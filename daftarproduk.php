    ...
    <div class="navigasi">
        ...
        <div class="pemesanan-produk">
            ...
            <form class="form-group" id="order-form" method="post" action="controller/simpanproduk_controller.php">
                ...
                <button id="kirim" type="submit" class="btn-primary">TAMBAH PRODUK</button>
            </form>
            <br>
            ...
            <?php
            // Menggabungkan data dari dua tabel, yaitu "produk" dan "kategori". Data produk diambil dari tabel "produk", sedangkan nama kategori diambil dari tabel "kategori"
